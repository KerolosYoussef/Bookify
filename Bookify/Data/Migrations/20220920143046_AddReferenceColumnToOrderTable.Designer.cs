...
namespace Bookify.Data.Migrations
{
    ...
    [Migration("20220920143046_AddReferenceColumnToOrderTable")]
    partial class AddReferenceColumnToOrderTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bookify.Models.BookOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bookify.Models.Identity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "f86c3d7d-1aaa-4471-b426-87846b1f4639",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedUserName = "MYUSER",
                            PasswordHash = "AQAAAAEAACcQAAAAEFEhrG0HezE76Dl80VhHxXyP8MDGpkVSqrAVeYMfoqvE/oHS0aMO+HOQGqjDY6r8Jw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "1356f665-a04b-4b24-8815-7131a907c238",
                            TwoFactorEnabled = false,
                            UserName = "admin@admin.com"
                        });
                });

            modelBuilder.Entity("Bookify.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "a10effd5-89e8-4c2c-8cdc-8157d4cc5629",
                            Name = "Admin"
                        },
                        new
                        {
                            Id = "6edbfb85-b8d6-4107-8c23-070fd52c8fcd",
                            ConcurrencyStamp = "998c32f0-35c7-4810-a5ef-f61fa4d23920",
                            Name = "Customer"
                        });
                });
            ...
            modelBuilder.Entity("Bookify.Models.BookOrder", b =>
                {
                    ...
                    b.HasOne("Bookify.Models.Order", "Order")
                        .WithMany()
