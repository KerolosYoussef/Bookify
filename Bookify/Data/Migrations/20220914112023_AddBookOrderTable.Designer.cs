...
namespace Bookify.Data.Migrations
{
    ...
    [Migration("20220914112023_AddBookOrderTable")]
    partial class AddBookOrderTable
    {
            ...
            modelBuilder.Entity("Bookify.Models.Identity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "cb508f97-a438-4a10-a1cd-ea1072abc534",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedUserName = "MYUSER",
                            PasswordHash = "AQAAAAEAACcQAAAAEDGXzLYt0ZljlbXRQvGfd4d1AmT62f2epzEEYiDyBXka6ht77SbRArrX8xOvySVWxg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "435314b4-415f-46e0-b481-39ee34a512c1",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "e8660b00-a8b1-4ccf-88b5-1c3fff8c8c04",
                            Name = "Admin"
                        },
                        new
                        {
                            Id = "f711cb82-d96a-45f2-9ea2-5b67a87e1962",
                            ConcurrencyStamp = "882f470c-ec16-42f4-8dd2-4a1c19955794",
                            Name = "Customer"
                        });
                });
            ...
            modelBuilder.Entity("BookOrder", b =>
                {
                    ...
                    b.HasOne("Bookify.Models.Order", null)
                        .WithMany()
